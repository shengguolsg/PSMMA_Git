...
!  WRITE(*,*) "PDGEMM finishes"
  ...
  time2 = MPI_Wtime()
  call psmma_toeplitz( n,n,one,B,1,1,desca,TA,ldta,zero,X,1,1,desca,WORK,REDIST )
...
end program psmma_testtoeplitz
