...
*  ===========
*
*       SUBROUTINE MDGEQP3( M, N, A, LDA, JPVT, TAU, WORK, LWORK, INFO, TOL, Rk )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, LDA, LWORK, M, N, Rk
...
*>
*  =====================================================================
      SUBROUTINE MDGEQP3( M,N,A,LDA,JPVT,TAU,WORK, LWORK,TOL,Rk,INFO )
*
...
*
               J = J + FJB
!               WRITE(*,*) "J, FJB=", J, FJB
               IF( ABS( A(J-1,J-1) ) <= TOL*ABS( A(1,1) )  ) THEN
                  Rk = J -1     ! This is an upper bound of rank
                  GO TO 40
               END IF
               GO TO 30
            END IF
